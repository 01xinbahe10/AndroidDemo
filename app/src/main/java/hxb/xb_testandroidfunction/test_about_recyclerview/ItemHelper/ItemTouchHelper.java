package hxb.xb_testandroidfunction.test_about_recyclerview.ItemHelper;
 ...
 * {@link androidx.recyclerview.widget.ItemTouchHelper.Callback#onMove(RecyclerView, ViewHolder, ViewHolder)} and / or
 * {@link androidx.recyclerview.widget.ItemTouchHelper.Callback#onSwiped(ViewHolder, int)}.
 * <p>
 ...
 * or {@link androidx.recyclerview.widget.ItemTouchHelper.Callback#onChildDrawOver(Canvas, RecyclerView, ViewHolder, float, float, int,
 * boolean)}.
 * <p/>
...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
     ...
     * {@link androidx.recyclerview.widget.ItemTouchHelper.Callback#getAbsoluteMovementFlags(RecyclerView, ViewHolder)} for the current
     * action state.
     */
    int mSelectedFlags;
    ...
    private void initGestureDetector() {
        ...
        mGestureDetector = new GestureDetectorCompat(mRecyclerView.getContext(),
                new ItemTouchHelper.ItemTouchHelperGestureListener());
    }
     ...
     * {@link androidx.recyclerview.widget.ItemTouchHelper.Callback#isLongPressDragEnabled()}.
     * <p>
     ...
     * ItemTouchHelper
     * is attached.</li>
     * <li>{@link androidx.recyclerview.widget.ItemTouchHelper.Callback} must have dragging enabled.</li>
     ...
     *                   RecyclerView.
     * @see androidx.recyclerview.widget.ItemTouchHelper.Callback#isItemViewSwipeEnabled()
     */
     ...
     * behavior
     * by overriding {@link androidx.recyclerview.widget.ItemTouchHelper.Callback}
     * <p>
     * For this method to work:
     * <ul>
     * <li>The provided ViewHolder must be a child of the RecyclerView to which this
     * ItemTouchHelper is attached.</li>
     * <li>{@link androidx.recyclerview.widget.ItemTouchHelper.Callback} must have swiping enabled.</li>
     * <li>There must be a previous touch event that was reported to the ItemTouchHelper
     * through RecyclerView's ItemTouchListener mechanism. As long as no other ItemTouchListener
     * grabs previous events, this should work as expected.</li>
     * </ul>
        ...
        if (Math.abs(mDx) > Math.abs(mDy)) {
            if ((swipeDir = checkHorizontalSwipe(viewHolder, flags)) > 0) {
                ...
                if ((originalFlags & swipeDir) == 0) {
                    // convert to relative
                    return androidx.recyclerview.widget.ItemTouchHelper.Callback.convertToRelativeDirection(swipeDir,
                            ViewCompat.getLayoutDirection(mRecyclerView));
                }
                return swipeDir;
            }
     ...
     * {@link androidx.recyclerview.widget.ItemTouchHelper.Callback#onMove(RecyclerView, ViewHolder, ViewHolder)
    ...
    public abstract static class Callback {
        ...
        /**
         * Returns the {@link ItemTouchUIUtil} that is used by the {@link androidx.recyclerview.widget.ItemTouchHelper.Callback} class for
         * visual
         ...
         * <p>
         * By default, {@link androidx.recyclerview.widget.ItemTouchHelper.Callback} applies these changes on
         ...
         * </pre>
         *
         * @return The {@link ItemTouchUIUtil} instance that is used by the {@link androidx.recyclerview.widget.ItemTouchHelper.Callback}
         */
        ...
        public void onMoved(final RecyclerView recyclerView,
            ...
            if (layoutManager instanceof androidx.recyclerview.widget.ItemTouchHelper.ViewDropHandler) {
                ((androidx.recyclerview.widget.ItemTouchHelper.ViewDropHandler) layoutManager).prepareForDrop(viewHolder.itemView,
                        target.itemView, x, y);
                return;
            }
            ...
            if (child != null) {
                ...
                if (vh != null) {
                    ...
                    if (pointerId == mActivePointerId) {
                        ...
                        if (mCallback.clickLocalDrag(mInitialTouchX,mInitialTouchY,vh)){
                            return;
                        }
                        Log.e(TAG, "onLongPress: childX:"+child.getX()+"  childY:"+child.getY() );
                        Log.e(TAG, "onLongPress: vh.itemView X:"+vh.itemView.getX()+"  vh.itemView Y:"+vh.itemView.getY() );
