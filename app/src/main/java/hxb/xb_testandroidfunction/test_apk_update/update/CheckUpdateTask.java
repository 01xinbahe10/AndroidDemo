package hxb.xb_testandroidfunction.test_apk_update.update;
...
//            String apkUrl = obj.getString(Constants.APK_DOWNLOAD_URL);//下载apk 链接
//            String apkUrl = "http://192.168.200.174:80/app.apk";
            String apkUrl = "http://192.168.11.213/testUpdate.apk";
