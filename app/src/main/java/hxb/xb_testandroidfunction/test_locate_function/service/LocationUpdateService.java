package hxb.xb_testandroidfunction.test_locate_function.service;
            ...
            for (String provider : allProviders) {
                ...
                if ((provider != null) && (PROVIDER_ARRAY.contains(provider))) {
                    if (LocationManager.GPS_PROVIDER.equals(provider)) {
                        ...
                        locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 10000, 200, gpsLocationListener);
                    } else if (LocationManager.NETWORK_PROVIDER.equals(provider)) {
                        Log.i("gps", "正在使用流基站感器");
                        locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 10000, 200, networkLocationListener);
                    }
