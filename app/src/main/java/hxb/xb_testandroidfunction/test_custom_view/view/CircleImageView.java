...
/**
 * Created by techgiant101 on 2017/3/9.
 */
...
//        MatrixcreateScaleBitmap
    ...
    private void updateShaderMatrix() {
        ...
        Log.e(TAG, "updateShaderMatrix: scale:"+scale+" dx:"+dx+" dy:"+dy+" mBitmapWidth:"+mBitmapWidth +" mBitmapHeight:"+mBitmapHeight+" mDrawableRect.width():"+mDrawableRect.width()+" mDrawableRect.height():"+mDrawableRect.height()+" ");
