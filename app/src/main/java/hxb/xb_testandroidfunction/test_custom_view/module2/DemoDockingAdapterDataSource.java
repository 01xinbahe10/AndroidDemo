package hxb.xb_testandroidfunction.test_custom_view.module2;
...
import hxb.xb_testandroidfunction.test_custom_view.adapter2.IDockingAdapterDataSource;
...
public class DemoDockingAdapterDataSource implements IDockingAdapterDataSource {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_group_view2, parent, false);
        }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_child_view2, parent, false);
        }
