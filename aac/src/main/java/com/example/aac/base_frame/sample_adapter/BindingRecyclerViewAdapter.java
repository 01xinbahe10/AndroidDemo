...
public class BindingRecyclerViewAdapter<VM> extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements BindingCollectionAdapter<VM> {
    ...
    private ItemIds<? super VM> itemIds;
    ...
    @Override
    public void onBindBinding(ViewDataBinding binding, int variableId, @LayoutRes int layoutRes, int position, VM item) {
    ...
    public interface ItemIds<VM> {
        long getItemId(int position, VM item);
    }
     ...
     */
    public void setItemIds(@Nullable ItemIds<? super VM> itemIds) {
